...
""let g:syntastic_lua_luacheck_args = "--no-unused-args --no-redefined --no-max-line-length --std ngx_lua --ignore 542 551"
"let g:syntastic_lua_luacheck_args = "--ignore 542 551"
